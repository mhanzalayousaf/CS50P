...
### Final Project: [Simple Calculator](https://github.com/mhanzalayousaf/CS50P/tree/main/Simple%20Calculator)
<br/>

## :warning: Disclaimer:

### ❗ **The provided code is intended solely for educational purposes and should not be utilized or submitted as your own solution.**

### ❗ **Engaging in cheating goes against the [Academic Honesty](https://cs50.harvard.edu/python/2022/honesty/) policy of the course, and it undermines the purpose of learning programming effectively.**
